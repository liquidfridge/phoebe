...
<html xmlns="http://www.w3.org/1999/xhtml" lang="<?php print $language->language; ?>" xml:lang="<?php print $language->language; ?>" dir="<?php print $dir; ?>">
  <head>
    ...
    <link type="text/css" rel="stylesheet" href="<?php print $theme_url; ?>/css/phoebe.print.css" />
    <?php if ($language_rtl): ?>
      <link type="text/css" rel="stylesheet" href="<?php print $theme_url; ?>/css/phoebe.print-rtl.css" />
    <?php endif; ?>
  </head>
  <body>
    <?php if ($site_name): ?>
